...
public class ClientSubscriberCustomBean {
  ...
  public ClientSubscriberCustomBean() {
  }
  ...
  public String toString() {
    final String TAB = " ";
    String retValue = "";
    retValue = "ClientSubscriberCustomBean ( " + "id = " + this.id + TAB
        + "clientSubscriberId = " + this.clientSubscriberId + TAB
        + "custom0 = " + this.custom0 + TAB + "custom1 = " + this.custom1 + TAB
        + "custom2 = " + this.custom2 + TAB + "custom3 = " + this.custom3 + TAB
        + "custom4 = " + this.custom4 + TAB + "custom5 = " + this.custom5 + TAB
        + "custom6 = " + this.custom6 + TAB + "custom7 = " + this.custom7 + TAB
        + "custom8 = " + this.custom8 + TAB + "custom9 = " + this.custom9 + TAB
        + "custom10 = " + this.custom10 + TAB + "custom11 = " + this.custom11
        + TAB + "custom12 = " + this.custom12 + TAB + "custom13 = "
        + this.custom13 + TAB + "custom14 = " + this.custom14 + TAB
        + "custom15 = " + this.custom15 + TAB + "custom16 = " + this.custom16
        + TAB + "custom17 = " + this.custom17 + TAB + "custom18 = "
        + this.custom18 + TAB + "custom19 = " + this.custom19 + TAB
        + "custom20 = " + this.custom20 + TAB + "custom21 = " + this.custom21
        + TAB + "custom22 = " + this.custom22 + TAB + "custom23 = "
        + this.custom23 + TAB + "custom24 = " + this.custom24 + TAB
        + "custom25 = " + this.custom25 + TAB + "custom26 = " + this.custom26
        + TAB + "custom27 = " + this.custom27 + TAB + "custom28 = "
        + this.custom28 + TAB + "custom29 = " + this.custom29 + TAB
        + "custom30 = " + this.custom30 + TAB + " )";
    return retValue;
  }
