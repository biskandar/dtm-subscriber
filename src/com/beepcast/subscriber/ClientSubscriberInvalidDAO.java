...
public class ClientSubscriberInvalidDAO {
  ...
  public ClientSubscriberInvalidDAO() {
  ...
  public ClientSubscriberInvalidBean queryClientSubscriberInvalidBean(
    ...
    String sqlFrom = "FROM client_subscriber_invalid ";
  ...
  public boolean isPhoneExist( boolean debug , int clientId , String phoneNumber ) {
    return ( queryClientSubscriberInvalidBean( debug , clientId , phoneNumber ) != null );
  }
  ...
  public boolean insertNewPhone( boolean debug , int clientId ,
    ...
    String sqlInsert = "INSERT INTO client_subscriber_invalid "
  ...
  public boolean deletePhone( boolean debug , int clientId , String phoneNumber ) {
    ...
    String sqlUpdate = "UPDATE client_subscriber_invalid ";
  ...
  private ClientSubscriberInvalidBean populateRecord( QueryResult qr ) {
    ClientSubscriberInvalidBean bean = new ClientSubscriberInvalidBean();
